...
class ThirdWelcome extends Component<IWelcomeProps> {
						...
						<Container fluid>
							<View style={styles.row}>
								<View style={[styles.col, styles.firstCol]}>
									<Container center>
										<Image
											source={require('../assets/img/third-welcome-img.png')}
											style={styles.img}
										/>
									</Container>
								</View>
								<View style={[styles.col, styles.secondCol]}>
									<Text style={styles.title}>Tasks and assign</Text>
								...
								<View style={[styles.col, styles.thirdCol]}>
									<ImageBackground
										source={require('../assets/img/tertiary-wave.png')}
										style={styles.wave}>
...
export default connect(null, null)(ThirdWelcome);
